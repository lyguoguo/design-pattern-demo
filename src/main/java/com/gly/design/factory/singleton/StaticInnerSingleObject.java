 ...
 */
public class StaticInnerSingleObject {
    public static class SingletonHole{
        public static final StaticInnerSingleObject INSTANCE = new StaticInnerSingleObject();
    }

    private StaticInnerSingleObject(){}

    public static StaticInnerSingleObject getInstance(){
